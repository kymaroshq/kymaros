...
type RouteRegistrar func(mux *http.ServeMux, q *Queries, lm *license.LicenseManager)
...
func NewServer(c client.Client, port int, staticDir string, lm *license.LicenseManager) *Server {
	return &Server{
		client:    c,
		port:      port,
		staticDir: staticDir,
...
func (s *Server) Start(ctx context.Context) error {
	q := NewQueries(s.client, s.license)
