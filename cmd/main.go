...
func main() {
	...
	// Start the embedded API server + frontend as a manager Runnable.
	// It uses the manager's cached client (started when mgr.Start is called).
	apiServer := kymarosapi.NewServer(mgr.GetClient(), apiPort, staticDir)
