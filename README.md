...
```
                         ...
                         │        Kymaros Operator          │
RestoreTest CR ─────────>│                                  │
                         │  Reconciler ──> Sandbox Manager  │──> Namespace + NetworkPolicy
HealthCheckPolicy CR ───>│      │                           │
                         │      ├──> Velero Adapter         │──> velero.io/v1 Restore
                         │      ├──> Health Check Runner    │──> Pod? HTTP? TCP? Exists?
                         │      └──> Report Generator       │
RestoreReport CR <───────│          + Score Calculator      │
                         │                                  │
